...
Inherits ServerSocket
	...
	#tag Method, Flags = &h0
		Sub Constructor(Args() As String = Nil)
		  ...
		  SSLConnectionType = SSLSocket.SSLConnectionTypes.TLSv12
		  CertificateFile = XJ.getFolderItem("").Parent.Child("certificates").Child("default-certificate.crt")
		  CertificatePassword = ""
		  KeepAlive = True
		  ...
		  If Args <> Nil Then
		    ...
		    If Arguments.HasKey("--CertificateFile") Then 
		      ...
		      CertificateFile = XJ.getFolderItem(Arguments.Value("--CertificateFile"), FolderItem.PathModes.Shell)
		    End If
	...
	#tag Method, Flags = &h0
		Sub ServerInfoDisplay()
		  ...
		  + If(Secure , "• SSL Connection Type: " + SSLConnectionType.ToText()  + EndOfLine, "") _
